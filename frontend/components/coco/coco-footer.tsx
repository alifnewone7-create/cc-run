  ...
  return (
    <footer id="support" className="coco-dark coco-shade scroll-mt-24">
      <div className="mx-auto max-w-[1200px] px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        ...
        <div className="flex flex-col gap-8 py-10 md:flex-row md:items-center md:justify-between">
          <a href="/#top" className="flex items-center gap-2.5">
            <span className="relative h-9 w-9 overflow-hidden rounded-xl ring-1 ring-white/20">
              <Image src="/coco-ai.jpg" alt="Coco AI logo" fill className="object-cover" sizes="36px" />
            </span>
        ...
        <div className="flex gap-3 rounded-2xl border border-white/10 bg-white/[0.03] p-5">
        ...
        <p className="coco-mono mt-8 text-center text-[11px] uppercase text-white/35">
